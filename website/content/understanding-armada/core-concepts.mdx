...
For more details, see the [scheduling documentation](https://github.com/armadaproject/armada/blob/master/docs/scheduling_and_preempting_jobs.md).
...
For detailed algorithm documentation, see the [priority algorithm documentation](https://github.com/armadaproject/armada/blob/master/docs/priority_algorithm.md).
...
- [Scheduling and Preempting Jobs](https://github.com/armadaproject/armada/blob/master/docs/scheduling_and_preempting_jobs.md)
- [Priority Algorithm](https://github.com/armadaproject/armada/blob/master/docs/priority_algorithm.md)
- [Creating and Submitting Jobs](https://github.com/armadaproject/armada/blob/master/docs/creating_and_submitting_jobs.md)
