...
For more details, see the [architecture documentation](https://github.com/armadaproject/armada/blob/master/docs/architecture.md).
...
- [System Overview](https://github.com/armadaproject/armada/blob/master/docs/system_overview.md)
- [Architecture Deep Dive](https://github.com/armadaproject/armada/blob/master/docs/architecture.md)
- [Maintaining Consistency](https://github.com/armadaproject/armada/blob/master/docs/maintaining_consistency_across_views.md)
