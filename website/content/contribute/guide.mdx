...
- **For Armada core development**: See the [Developer Guide](/developer-guide) for local setup, code structure, and development workflows
...
For real-time discussions, Slack channels, GitHub Discussions, and community meetings, see our [Community page](/community).
